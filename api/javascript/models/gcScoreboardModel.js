...
const hostelOverallStandingsPointsSchema = new mongoose.Schema({
    "hostelName" : {
        type: String,
        required: true,
        enum: ["Brahmaputra","Kameng","Dihing","Barak","Kapili","Lohit","Manas","Married Scholars (Men)","Married Scholars (Women)","Siang","Subansiri","Umiam","Dhansiri",,"Disang (Men)","Disang (Women)"]
    },
    "points" : {
        type: Number,
        required: true
